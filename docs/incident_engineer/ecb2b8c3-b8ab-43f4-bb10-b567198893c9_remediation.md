# Incident remediation: `ecb2b8c3-b8ab-43f4-bb10-b567198893c9`

## RCA summary
The table 'ECOMMERCE_DB.RAW.CUSTOMERS_MISSING' does not exist or the user does not have the necessary permissions to access it.
