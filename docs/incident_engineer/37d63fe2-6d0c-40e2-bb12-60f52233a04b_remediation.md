# Incident remediation: `37d63fe2-6d0c-40e2-bb12-60f52233a04b`

## RCA summary
The SQL compilation error is due to an invalid identifier 'PRODUCTNAME' in the SQL code.
...
_Add missing column product_name to schema.yml_
