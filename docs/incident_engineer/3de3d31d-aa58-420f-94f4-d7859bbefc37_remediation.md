# Incident remediation: `3de3d31d-aa58-420f-94f4-d7859bbefc37`

## RCA summary
The SQL compilation error is caused by the reference to an invalid identifier 'DISCOUNT_AMOUNT', which does not exist in the source table 'ECOMMERCE_DB.RAW.ORDER_ITEMS'.
