# Incident remediation: `1ee53011-a0dc-4e76-9cfc-839387ed54a1`

## RCA summary
The SQL query in the 'products' model is missing a 'GROUP BY' clause for the non-aggregated columns 'category' and 'brand'.
...
_Add GROUP BY clause for category and brand_
